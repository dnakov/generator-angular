...
describe('Angular generator', function () {
  ...
  beforeEach(function (done) {
    ...
    helpers.testDirectory(path.join(__dirname, 'temp'), function (err) {
      ...
      angular = helpers.createGenerator('vfangular:app', deps);
  ...
  function generatorTest(generatorType, specType, targetDirectory, scriptNameFn, specNameFn, suffix, done) {
    ...
    angularGenerator = helpers.createGenerator('vfangular:' + generatorType, deps, [name]);
  ...
  describe('View', function () {
    it('should generate a new view', function (done) {
      var angularView;
      var deps = ['../../view'];
      angularView = helpers.createGenerator('vfangular:view', deps, ['foo']);
    ...
    it('should generate a new view in subdirectories', function (done) {
      var angularView;
      var deps = ['../../view'];
      angularView = helpers.createGenerator('vfangular:view', deps, ['foo/bar']);
